...
from models.segmentation2D.transunet.blocks.common import DoubleConv


class EncoderLayer(nn.Module):
    def __init__(self, c1, c2, padding, activation='relu', norm='batch', input_shape=None, pool='max'):
        """
